...
:root {
  --cdlsxs: var(--cds-token-layout-space-xs);
  --cdlssm: var(--cds-token-layout-space-sm);
  --cdlsmd: var(--cds-token-layout-space-md);
  --cdlslg: var(--cds-token-layout-space-lg);
  --cdlsxl: var(--cds-token-layout-space-xl);
}

[cds-layout~=horizontal][cds-layout~="gap:none"] {
  margin: calc(-1 * 0) 0 0 calc(-1 * 0);
  width: calc(100% + 0);
}
[cds-layout~=horizontal][cds-layout~="gap:none"] > * {
  margin: 0 0 0 0;
...
[cds-layout~=horizontal][cds-layout~="gap:xs"] {
  margin: calc(-1 * var(--cdlsxs, 0.3rem)) 0 0 calc(-1 * var(--cdlsxs, 0.3rem));
  width: calc(100% + var(--cdlsxs, 0.3rem));
}
[cds-layout~=horizontal][cds-layout~="gap:xs"] > * {
  margin: var(--cdlsxs, 0.3rem) 0 0 var(--cdlsxs, 0.3rem);
}

[cds-layout~=horizontal][cds-layout~="gap:sm"] {
  margin: calc(-1 * var(--cdlssm, 0.6rem)) 0 0 calc(-1 * var(--cdlssm, 0.6rem));
  width: calc(100% + var(--cdlssm, 0.6rem));
}
[cds-layout~=horizontal][cds-layout~="gap:sm"] > * {
  margin: var(--cdlssm, 0.6rem) 0 0 var(--cdlssm, 0.6rem);
}

[cds-layout~=horizontal][cds-layout~="gap:md"] {
  margin: calc(-1 * var(--cdlsmd, 1.2rem)) 0 0 calc(-1 * var(--cdlsmd, 1.2rem));
  width: calc(100% + var(--cdlsmd, 1.2rem));
}
[cds-layout~=horizontal][cds-layout~="gap:md"] > * {
  margin: var(--cdlsmd, 1.2rem) 0 0 var(--cdlsmd, 1.2rem);
}

[cds-layout~=horizontal][cds-layout~="gap:lg"] {
  margin: calc(-1 * var(--cdlslg, 2.4rem)) 0 0 calc(-1 * var(--cdlslg, 2.4rem));
  width: calc(100% + var(--cdlslg, 2.4rem));
}
[cds-layout~=horizontal][cds-layout~="gap:lg"] > * {
  margin: var(--cdlslg, 2.4rem) 0 0 var(--cdlslg, 2.4rem);
}

[cds-layout~=horizontal][cds-layout~="gap:xl"] {
  margin: calc(-1 * var(--cdlsxl, 4.8rem)) 0 0 calc(-1 * var(--cdlsxl, 4.8rem));
  width: calc(100% + var(--cdlsxl, 4.8rem));
}
[cds-layout~=horizontal][cds-layout~="gap:xl"] > * {
  margin: var(--cdlsxl, 4.8rem) 0 0 var(--cdlsxl, 4.8rem);
}
...
[cds-layout~=horizontal][cds-layout~=no-wrap] {
  flex-wrap: nowrap;
}
...
[cds-layout~=horizontal][cds-layout~="align:stretch"] > *, [cds-layout~=horizontal][cds-layout~="align:horizontal-stretch"] > * {
  flex-grow: 1;
}
[cds-layout~=horizontal][cds-layout~="align:stretch"] > *, [cds-layout~=horizontal][cds-layout~="align:vertical-stretch"] {
  align-content: stretch;
}
[cds-layout~=horizontal] [cds-layout~="align:stretch"] {
  flex-grow: 1 !important;
}
[cds-layout~=horizontal] [cds-layout~="align:shrink"] {
...
[cds-layout~=vertical][cds-layout~="gap:xs"] > * {
  margin-bottom: var(--cdlsxs, 0.3rem);
}

[cds-layout~=vertical][cds-layout~="gap:sm"] > * {
  margin-bottom: var(--cdlssm, 0.6rem);
}

[cds-layout~=vertical][cds-layout~="gap:md"] > * {
  margin-bottom: var(--cdlsmd, 1.2rem);
}

[cds-layout~=vertical][cds-layout~="gap:lg"] > * {
  margin-bottom: var(--cdlslg, 2.4rem);
}

[cds-layout~=vertical][cds-layout~="gap:xl"] > * {
  margin-bottom: var(--cdlsxl, 4.8rem);
}
...
[cds-layout~=vertical] > *:last-child {
  margin-bottom: 0;
}
...
[cds-layout~=vertical][cds-layout~="align:stretch"] > *, [cds-layout~=vertical][cds-layout~="align:vertical-stretch"] > * {
  flex-grow: 1;
}
[cds-layout~=vertical] [cds-layout~="align:stretch"] {
  flex-grow: 1 !important;
}
[cds-layout~=vertical] [cds-layout~="align:shrink"] {
  flex-shrink: 1 !important;
  flex-grow: 0 !important;
}
[cds-layout~=vertical] [cds-layout~="align:center"],
...
[cds-layout~=grid][cds-layout~="gap:none"] {
  grid-gap: 0;
}

[cds-layout~=grid][cds-layout~="gap:xs"] {
  grid-gap: var(--cdlsxs, 0.3rem);
}

[cds-layout~=grid][cds-layout~="gap:sm"] {
  grid-gap: var(--cdlssm, 0.6rem);
}

[cds-layout~=grid][cds-layout~="gap:md"] {
  grid-gap: var(--cdlsmd, 1.2rem);
}

[cds-layout~=grid][cds-layout~="gap:lg"] {
  grid-gap: var(--cdlslg, 2.4rem);
}

[cds-layout~=grid][cds-layout~="gap:xl"] {
  grid-gap: var(--cdlsxl, 4.8rem);
}
...
@media (min-width: 480px) {
  [cds-layout~=grid][cds-layout~="gap@xs:none"] {
    grid-gap: 0;
  }

  [cds-layout~=grid][cds-layout~="gap@xs:xs"] {
    grid-gap: var(--cdlsxs, 0.3rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xs:sm"] {
    grid-gap: var(--cdlssm, 0.6rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xs:md"] {
    grid-gap: var(--cdlsmd, 1.2rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xs:lg"] {
    grid-gap: var(--cdlslg, 2.4rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xs:xl"] {
    grid-gap: var(--cdlsxl, 4.8rem);
  }
}
@media (min-width: 720px) {
  [cds-layout~=grid][cds-layout~="gap@sm:none"] {
    grid-gap: 0;
  }

  [cds-layout~=grid][cds-layout~="gap@sm:xs"] {
    grid-gap: var(--cdlsxs, 0.3rem);
  }

  [cds-layout~=grid][cds-layout~="gap@sm:sm"] {
    grid-gap: var(--cdlssm, 0.6rem);
  }

  [cds-layout~=grid][cds-layout~="gap@sm:md"] {
    grid-gap: var(--cdlsmd, 1.2rem);
  }

  [cds-layout~=grid][cds-layout~="gap@sm:lg"] {
    grid-gap: var(--cdlslg, 2.4rem);
  }

  [cds-layout~=grid][cds-layout~="gap@sm:xl"] {
    grid-gap: var(--cdlsxl, 4.8rem);
  }
}
@media (min-width: 1024px) {
  [cds-layout~=grid][cds-layout~="gap@md:none"] {
    grid-gap: 0;
  }

  [cds-layout~=grid][cds-layout~="gap@md:xs"] {
    grid-gap: var(--cdlsxs, 0.3rem);
  }

  [cds-layout~=grid][cds-layout~="gap@md:sm"] {
    grid-gap: var(--cdlssm, 0.6rem);
  }

  [cds-layout~=grid][cds-layout~="gap@md:md"] {
    grid-gap: var(--cdlsmd, 1.2rem);
  }

  [cds-layout~=grid][cds-layout~="gap@md:lg"] {
    grid-gap: var(--cdlslg, 2.4rem);
  }

  [cds-layout~=grid][cds-layout~="gap@md:xl"] {
    grid-gap: var(--cdlsxl, 4.8rem);
  }
}
@media (min-width: 1200px) {
  [cds-layout~=grid][cds-layout~="gap@lg:none"] {
    grid-gap: 0;
  }

  [cds-layout~=grid][cds-layout~="gap@lg:xs"] {
    grid-gap: var(--cdlsxs, 0.3rem);
  }

  [cds-layout~=grid][cds-layout~="gap@lg:sm"] {
    grid-gap: var(--cdlssm, 0.6rem);
  }

  [cds-layout~=grid][cds-layout~="gap@lg:md"] {
    grid-gap: var(--cdlsmd, 1.2rem);
  }

  [cds-layout~=grid][cds-layout~="gap@lg:lg"] {
    grid-gap: var(--cdlslg, 2.4rem);
  }

  [cds-layout~=grid][cds-layout~="gap@lg:xl"] {
    grid-gap: var(--cdlsxl, 4.8rem);
  }
}
@media (min-width: 1440px) {
  [cds-layout~=grid][cds-layout~="gap@xl:none"] {
    grid-gap: 0;
  }

  [cds-layout~=grid][cds-layout~="gap@xl:xs"] {
    grid-gap: var(--cdlsxs, 0.3rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xl:sm"] {
    grid-gap: var(--cdlssm, 0.6rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xl:md"] {
    grid-gap: var(--cdlsmd, 1.2rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xl:lg"] {
    grid-gap: var(--cdlslg, 2.4rem);
  }

  [cds-layout~=grid][cds-layout~="gap@xl:xl"] {
    grid-gap: var(--cdlsxl, 4.8rem);
  }
}
@media (min-width: 480px) {
...
[cds-layout~="p:xs"] {
  padding: var(--cdlsxs, 0.3rem) !important;
}

[cds-layout~="m:xs"] {
  margin: var(--cdlsxs, 0.3rem) !important;
}

[cds-layout~="p:sm"] {
  padding: var(--cdlssm, 0.6rem) !important;
}

[cds-layout~="m:sm"] {
  margin: var(--cdlssm, 0.6rem) !important;
}

[cds-layout~="p:md"] {
  padding: var(--cdlsmd, 1.2rem) !important;
}

[cds-layout~="m:md"] {
  margin: var(--cdlsmd, 1.2rem) !important;
}

[cds-layout~="p:lg"] {
  padding: var(--cdlslg, 2.4rem) !important;
}

[cds-layout~="m:lg"] {
  margin: var(--cdlslg, 2.4rem) !important;
}

[cds-layout~="p:xl"] {
  padding: var(--cdlsxl, 4.8rem) !important;
}

[cds-layout~="m:xl"] {
  margin: var(--cdlsxl, 4.8rem) !important;
}
...
[cds-layout~="p-x:xs"] {
  padding-left: var(--cdlsxs, 0.3rem) !important;
  padding-right: var(--cdlsxs, 0.3rem) !important;
}

[cds-layout~="p-y:xs"] {
  padding-top: var(--cdlsxs, 0.3rem) !important;
  padding-bottom: var(--cdlsxs, 0.3rem) !important;
}

[cds-layout~="m-x:xs"] {
  margin-left: var(--cdlsxs, 0.3rem) !important;
  margin-right: var(--cdlsxs, 0.3rem) !important;
}

[cds-layout~="m-y:xs"] {
  margin-top: var(--cdlsxs, 0.3rem) !important;
  margin-bottom: var(--cdlsxs, 0.3rem) !important;
}

[cds-layout~="p-x:sm"] {
  padding-left: var(--cdlssm, 0.6rem) !important;
  padding-right: var(--cdlssm, 0.6rem) !important;
}

[cds-layout~="p-y:sm"] {
  padding-top: var(--cdlssm, 0.6rem) !important;
  padding-bottom: var(--cdlssm, 0.6rem) !important;
}

[cds-layout~="m-x:sm"] {
  margin-left: var(--cdlssm, 0.6rem) !important;
  margin-right: var(--cdlssm, 0.6rem) !important;
}

[cds-layout~="m-y:sm"] {
  margin-top: var(--cdlssm, 0.6rem) !important;
  margin-bottom: var(--cdlssm, 0.6rem) !important;
}

[cds-layout~="p-x:md"] {
  padding-left: var(--cdlsmd, 1.2rem) !important;
  padding-right: var(--cdlsmd, 1.2rem) !important;
}

[cds-layout~="p-y:md"] {
  padding-top: var(--cdlsmd, 1.2rem) !important;
  padding-bottom: var(--cdlsmd, 1.2rem) !important;
}

[cds-layout~="m-x:md"] {
  margin-left: var(--cdlsmd, 1.2rem) !important;
  margin-right: var(--cdlsmd, 1.2rem) !important;
}

[cds-layout~="m-y:md"] {
  margin-top: var(--cdlsmd, 1.2rem) !important;
  margin-bottom: var(--cdlsmd, 1.2rem) !important;
}

[cds-layout~="p-x:lg"] {
  padding-left: var(--cdlslg, 2.4rem) !important;
  padding-right: var(--cdlslg, 2.4rem) !important;
}

[cds-layout~="p-y:lg"] {
  padding-top: var(--cdlslg, 2.4rem) !important;
  padding-bottom: var(--cdlslg, 2.4rem) !important;
}

[cds-layout~="m-x:lg"] {
  margin-left: var(--cdlslg, 2.4rem) !important;
  margin-right: var(--cdlslg, 2.4rem) !important;
}

[cds-layout~="m-y:lg"] {
  margin-top: var(--cdlslg, 2.4rem) !important;
  margin-bottom: var(--cdlslg, 2.4rem) !important;
}

[cds-layout~="p-x:xl"] {
  padding-left: var(--cdlsxl, 4.8rem) !important;
  padding-right: var(--cdlsxl, 4.8rem) !important;
}

[cds-layout~="p-y:xl"] {
  padding-top: var(--cdlsxl, 4.8rem) !important;
  padding-bottom: var(--cdlsxl, 4.8rem) !important;
}

[cds-layout~="m-x:xl"] {
  margin-left: var(--cdlsxl, 4.8rem) !important;
  margin-right: var(--cdlsxl, 4.8rem) !important;
}

[cds-layout~="m-y:xl"] {
  margin-top: var(--cdlsxl, 4.8rem) !important;
  margin-bottom: var(--cdlsxl, 4.8rem) !important;
}
...
[cds-layout~="container:xs"] {
  width: 100%;
  max-width: var(--cds-token-layout-width-xs, 480px);
}

[cds-layout~="container:sm"] {
  width: 100%;
  max-width: var(--cds-token-layout-width-sm, 720px);
}

[cds-layout~="container:md"] {
  width: 100%;
  max-width: var(--cds-token-layout-width-md, 1024px);
}
